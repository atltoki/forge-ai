    ...
    <section id="getting-started" className="relative flex min-h-screen flex-col items-center overflow-hidden px-5 pb-20 pt-32 md:px-8 md:pt-40">
      ...
      <div className="relative mt-20 w-full max-w-6xl pb-10">
        ...
        <div className="relative overflow-hidden rounded-[1.6rem] border border-white/10 bg-[#111216] p-2 shadow-[0_35px_120px_rgba(0,0,0,.65)] md:p-3">
          ...
          <div className="relative aspect-[16/9] overflow-hidden rounded-2xl bg-[#15161b]"><img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1800&q=82" alt="Aperçu d’un tableau de bord analytique" className="h-full w-full object-cover opacity-25 saturate-0" loading="eager" /><div className="absolute inset-0 bg-gradient-to-br from-[#101114]/20 via-[#101114]/65 to-[#101114]"/><div className="absolute inset-0 grid gap-3 p-4 sm:grid-cols-3 md:gap-5 md:p-8"><div className="rounded-2xl border border-[#b8ff5c]/20 bg-black/55 p-4 backdrop-blur md:col-span-2"><p className="font-mono text-[9px] uppercase tracking-[.14em] text-[#b8ff5c]">Aperçu produit</p><h2 className="mt-3 text-lg font-medium text-white md:text-2xl">Prospection internationale</h2><p className="mt-2 max-w-lg text-xs leading-5 text-white/40">Atlas vérifie les entreprises, leurs sites et les sources publiques.</p><div className="mt-8 h-1.5 overflow-hidden rounded-full bg-white/10"><div className="h-full w-3/4 rounded-full bg-[#b8ff5c]"/></div></div><div className="rounded-2xl border border-white/10 bg-black/55 p-4 backdrop-blur"><p className="font-mono text-[9px] uppercase tracking-[.14em] text-violet-300">Réseau</p><div className="mt-5 grid place-items-center"><Orbit className="text-[#b8ff5c]" size={62}/><p className="mt-4 text-sm text-white">Orion + Atlas</p><p className="mt-1 text-xs text-white/35">Agents coordonnés</p></div></div><div className="hidden rounded-2xl border border-white/10 bg-black/50 p-4 backdrop-blur sm:block"><p className="text-xs text-white/35">Sources</p><p className="mt-3 text-2xl text-white">Traçables</p></div><div className="hidden rounded-2xl border border-white/10 bg-black/50 p-4 backdrop-blur sm:block"><p className="text-xs text-white/35">Progression</p><p className="mt-3 text-2xl text-white">Temps réel</p></div><div className="hidden rounded-2xl border border-white/10 bg-black/50 p-4 backdrop-blur sm:block"><p className="text-xs text-white/35">Mémoire</p><p className="mt-3 text-2xl text-white">Persistante</p></div></div></div>
        </div>
      </div>
    </section>
