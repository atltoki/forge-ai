...
export default async function PilotagePage() {
  ...
  const [missionsResult, memoryResult, agentsResult, toolsResult, logsResult] = await Promise.all([
  ...
  return <Shell title="Pilotage Constellation">
    <div className="grid gap-5 xl:grid-cols-12">
      <div className="xl:col-span-7"><MissionSpotlight mission={spotlight} /></div>
      <div className="xl:col-span-5"><AgentConstellation agents={agents} tools={tools} /></div>
    </div>

    <section className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4" aria-label="Indicateurs du workspace">
